...
export const baseBackgrounds: Background[] = [
  {
    id: 'acolyte',
    name: 'Acolyte',
    ...
    languageCount: 2,
    equipment: [
      { name: 'A holy symbol', type: 'gear' },
      { name: 'A prayer book or prayer wheel', type: 'gear' },
      { name: '5 sticks of incense', type: 'gear' },
      { name: 'Vestments', type: 'gear' },
      { name: 'Common clothes', type: 'gear' },
      { name: 'A belt pouch containing 15 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    equipment: [
      { name: 'A set of fine clothes', type: 'gear' },
      { name: 'A disguise kit', type: 'tool' },
      {
        name: 'Tools of the con',
        type: 'gear',
        alternatives: [
          { name: 'Ten stoppered bottles filled with colored liquid', type: 'gear' },
          { name: 'A set of weighted dice', type: 'gear' },
          { name: 'A deck of marked cards', type: 'gear' },
          { name: 'A signet ring of an imaginary duke', type: 'gear' }
        ]
      },
      { name: 'A belt pouch containing 15 gp', type: 'gold' }
    ],
  ...
  },
  {
    ...
    equipment: [
      { name: 'A crowbar', type: 'tool' },
      { name: 'A set of dark common clothes including a hood', type: 'gear' },
      { name: 'A belt pouch containing 15 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    equipment: [
      { name: 'A musical instrument of your choice', type: 'tool' },
      { name: 'The favor of an admirer', type: 'gear' },
      { name: 'A costume', type: 'gear' },
      { name: 'A belt pouch containing 15 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    id: 'folk-hero',
    name: 'Folk Hero',
    description: 'You come from a humble social rank, but you are destined for so much more. Already the people of your home village regard you as their own champion, and your destiny calls you to stand against the tyrants and monsters that threaten the common folk everywhere.',
    skillProficiencies: ['Animal Handling', 'Survival'],
    toolProficiencies: ['One type of artisan\'s tools', 'Vehicles (land)'],
    equipment: [
      { name: 'A set of artisan\'s tools of your choice', type: 'tool' },
      { name: 'A shovel', type: 'tool' },
      { name: 'An iron pot', type: 'gear' },
      { name: 'A set of common clothes', type: 'gear' },
      { name: 'A belt pouch containing 10 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    equipment: [
      { name: 'A set of artisan\'s tools of your choice', type: 'tool' },
      { name: 'A letter of introduction from your guild', type: 'gear' },
      { name: 'A set of traveler\'s clothes', type: 'gear' },
      { name: 'A belt pouch containing 15 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    languageCount: 1,
    equipment: [
      { name: 'A scroll case stuffed full of notes from your studies or prayers', type: 'gear' },
      { name: 'A winter blanket', type: 'gear' },
      { name: 'A set of common clothes', type: 'gear' },
      { name: 'An herbalism kit', type: 'tool' },
      { name: '5 gp', type: 'gold' }
    ],
    feature: {
      name: 'Discovery',
  ...
  },
  {
    ...
    equipment: [
      { name: 'A set of fine clothes', type: 'gear' },
      { name: 'A signet ring', type: 'gear' },
      { name: 'A scroll of pedigree', type: 'gear' },
      { name: 'A purse containing 25 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    languageCount: 1,
    equipment: [
      { name: 'A staff', type: 'weapon' },
      { name: 'A hunting trap', type: 'gear' },
      { name: 'A trophy from an animal you killed', type: 'gear' },
      { name: 'A set of traveler\'s clothes', type: 'gear' },
      { name: 'A belt pouch containing 10 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    languageCount: 2,
    equipment: [
      { name: 'A bottle of black ink', type: 'gear' },
      { name: 'A quill', type: 'gear' },
      { name: 'A small knife', type: 'weapon' },
      { name: 'A letter from a dead colleague posing a question you have not yet been able to answer', type: 'gear' },
      { name: 'A set of common clothes', type: 'gear' },
      { name: 'A belt pouch containing 10 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    equipment: [
      { name: 'A club', type: 'weapon' },
      { name: 'A dagger', type: 'weapon' },
      { name: 'A lucky charm', type: 'gear' },
      { name: 'A set of common clothes', type: 'gear' },
      { name: 'A belt pouch containing 10 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    equipment: [
      { name: 'An insignia of rank', type: 'gear' },
      { name: 'A trophy taken from a fallen enemy', type: 'gear' },
      { name: 'A set of bone dice or deck of cards', type: 'gear' },
      { name: 'A set of common clothes', type: 'gear' },
      { name: 'A belt pouch containing 10 gp', type: 'gold' }
    ],
    feature: {
  ...
  },
  {
    ...
    equipment: [
      { name: 'A small knife', type: 'weapon' },
      { name: 'A map of the city you grew up in', type: 'gear' },
      { name: 'A pet mouse', type: 'gear' },
      { name: 'A token to remember your parents by', type: 'gear' },
      { name: 'A set of common clothes', type: 'gear' },
      { name: 'A belt pouch containing 10 gp', type: 'gold' }
    ],
    feature: {
...
const importedBackgrounds = getImportedBucket('backgrounds') as Background[];
export const backgrounds = mergeCollectionsById(baseBackgrounds, importedBackgrounds);
