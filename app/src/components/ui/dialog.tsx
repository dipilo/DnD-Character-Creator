...
type DialogRootProps = Readonly<React.ComponentProps<typeof DialogPrimitive.Root>>
...
type DialogContentProps = Readonly<React.ComponentProps<typeof DialogPrimitive.Content> & {
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // A centred fixed panel with no height cap runs off both ends of a landscape phone with
          // no way to reach either — dvh (not vh) so the browser's collapsing chrome is excluded.
