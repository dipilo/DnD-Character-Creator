  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        // Set per game system by store/themeStore.ts. Use it for decoration that should say which
        // game you are in (hero gradients, system badges), not for controls — those read --primary.
        brand: {
